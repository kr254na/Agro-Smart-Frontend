...
export default function ForgotPasswordPage() {
  ...
  const handleRequestOtp = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`https://agro-smart-backend-production.up.railway.app/api/auth/password/forgot?email=${formData.email}`, {
        method: 'POST'
      });
  ...
  const handleVerifyOtp = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`https://agro-smart-backend-production.up.railway.app/api/auth/password/verify-otp?email=${formData.email}&otp=${formData.otp}`, {
        method: 'POST'
      });
      const result = await response.json();
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://agro-smart-backend-production.up.railway.app/api/auth/password/reset', {
        method: 'POST',
